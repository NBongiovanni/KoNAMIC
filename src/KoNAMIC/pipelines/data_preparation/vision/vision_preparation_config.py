...
class VisionPreparationConfig:
    ...
    @classmethod
    def from_yaml(cls, path: Path) -> "VisionPreparationConfig":
        with open(path, "r", encoding="utf-8") as f:
            data = yaml.safe_load(f)
        return cls.from_dict(data)

    @classmethod
    def from_dict(cls, cfg: dict[str, Any]) -> "VisionPreparationConfig":
        ...
        return cls(
            ...
            dataloader=DataLoaderConfig(
                batch_size=int(dataloader.get("batch_size", 32)),
            ...
            scaler=ScalerConfig(
                scale_x=bool(scaler.get("scale_x", False)),
